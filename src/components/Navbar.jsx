      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        {!isAuthPage && (
          <div className="flex items-center gap-2 sm:gap-3">
            {isDashboard ? (
              <>
                {/* Active Username Badge (hidden on smallest screens) */}
                {activeUsername && (
                  <div className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-200/70 dark:bg-slate-900 border border-slate-300/80 dark:border-slate-800 text-xs font-mono font-bold text-slate-700 dark:text-slate-300">
                ...
                <button
                  ...
                  className="px-3 py-2 sm:px-3.5 sm:py-2.5 rounded-xl border border-slate-300 dark:border-slate-800 bg-white/80 dark:bg-slate-900 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 active:scale-[0.98] transition-all flex items-center gap-1.5 text-xs font-bold shadow-sm cursor-pointer"
                >
